...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | Survey | informed ML 到底是什么 | taxonomy | 全流程 | [PDF](../papers/survey/taxonomy_survey_2021_tkde.pdf), [TXT](../N-636331.txt) | 先建立地图 |
| 2 | Logic-net | 规则怎样进入 DNN | soft logic / rule distillation | 训练阶段 | [PDF](../papers/logic_net/logic_net_2016_arxiv.pdf), [TXT](../logic-net.txt) | 做最小 toy |
| 3 | Semantic Loss | 逻辑如何直接变成 loss | propositional logic | 输出层 / loss | [PDF](../papers/semantic_loss/semantic_loss_2018.pdf), [TXT](../logic2.txt) | 做 exactly-one 复现 |
| 4 | DL2 | 如何把逻辑做成系统 | declarative constraints | 训练 + 查询 | [PDF](../papers/dl2/dl2_2019_icml.pdf), [TXT](../Logic-1.txt), [Code](../dl2-master/dl2-master/README.md) | 先读代码再做 toy |
| 5 | Granular Computing for ML | 为什么需要粒化表达 | intervals / fuzzy / probabilistic granules | 数据层 + 模型层 + 知识层 | [PDF](../papers/granular/granular_computing_2025_tcyb.pdf), [TXT](../Granular_Computing_for_Machine_Learning_Pursuing_New_Development_Horizons.txt) | 建立第二条主线 |
| 6 | From Fuzzy Rule-Based Models to Granular Models | 如何从数值规则模型升级到粒化模型 | interval / fuzzy / probabilistic granules | 模型输出层 | [PDF](../papers/granular/fuzzy_to_granular_models_2025_tfuzz.pdf), [TXT](../From_Fuzzy_Rule-Based_Models_to_Granular_Models.txt) | 做区间输出 toy |
| 7 | Knowledge Landmarks | 局部数据 + 全局模糊知识如何联合建模 | input-output granule landmarks | 增强损失 regularizer | [PDF](../papers/knowledge_landmarks/knowledge_landmarks_2026.pdf) | 很适合后续自己延展 |
| 8 | Rough Set / Attribute Reduction | 混合数据下不确定性度量和约简 | KNN-neighbourhood rough set | 预处理 / 约简 | [PDF](../papers/rough_sets/rough_set_attribute_reduction_2025_asoc.pdf), [TXT](../feature_selection_asoc.txt) | 放在第二阶段 |
...
- [PDF](../papers/survey/taxonomy_survey_2021_tkde.pdf)
- [TXT](../N-636331.txt)
...
- [PDF](../papers/logic_net/logic_net_2016_arxiv.pdf)
- [TXT](../logic-net.txt)
...
- [PDF](../papers/semantic_loss/semantic_loss_2018.pdf)
- [TXT](../logic2.txt)
...
- [PDF](../papers/dl2/dl2_2019_icml.pdf)
- [TXT](../Logic-1.txt)
...
- [PDF](../papers/granular/granular_computing_2025_tcyb.pdf)
...
- [PDF](../papers/granular/fuzzy_to_granular_models_2025_tfuzz.pdf)
...
- [PDF](../papers/knowledge_landmarks/knowledge_landmarks_2026.pdf)
...
- [PDF](../papers/rough_sets/rough_set_attribute_reduction_2025_asoc.pdf)
